...
<script>
import { getRecord } from "../api/services";
import Vue from "vue";
    ...
    return {
      ...
      fields: [
        { key: "code", label: "ID" },
        {
          ...
          label: "Request Date",
          formatter: (value) => {
            return moment.utc(value).local().format("d/MM/YYYY");
          },
        },
        { key: "f_name", label: "Name" },
        { key: "l_name", label: "Last Name" },
        { key: "company_info.email", label: "Email" },
        { key: "company_info.company", label: "Company" },
        {
          key: "access_request",
          label: "Request Type",
          formatter: (value) => {
            return value == "door_access"
              ? "Door Access"
              : value == "badge"
              ? "Badg"
              : value == "gate_transponder"
              ? "Gate transponder"
              : "";
          },
        },
